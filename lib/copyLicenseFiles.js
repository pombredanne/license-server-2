...
module.exports = function(settings, repoName, htmlName, jsonName, callback) {

  var TEMP_LICENSOJSON = path.join(settings.staticPath, jsonName);
  var TEMP_LICENSEHTML = path.join(settings.staticPath, htmlName);
